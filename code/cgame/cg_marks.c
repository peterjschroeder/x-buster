...
//		CG_Printf( NULL,"CG_AddParticleToScene type %d p->pshader == ZERO\n", p->type);
        return;
    }
...
void CG_ParticleSnowFlurry (qhandle_t pshader, centity_t *cent)
{
    ...
    if (!pshader)
        CG_Printf( NULL,"CG_ParticleSnowFlurry pshader == ZERO!\n");
...
void CG_ParticleSnow (qhandle_t pshader, vec3_t origin, vec3_t origin2, int turb, float range, int snum)
{
    ...
    if (!pshader)
        CG_Printf( NULL,"CG_ParticleSnow pshader == ZERO!\n");
...
void CG_ParticleSmoke (qhandle_t pshader, centity_t *cent)
{
    ...
    if (!pshader)
        CG_Printf( NULL,"CG_ParticleSmoke == ZERO!\n");
...
void CG_ParticleImpactSmokePuff (qhandle_t pshader, vec3_t origin)
{
    ...
    if (!pshader)
        CG_Printf( NULL,"CG_ParticleImpactSmokePuff pshader == ZERO!\n");
    ...
    p->width = genrand_int32()%4 + 8;
    p->height = genrand_int32()%4 + 8;
...
void CG_Particle_Bleed (qhandle_t pshader, vec3_t start, vec3_t dir, int fleshEntityNum, int duration)
{
    ...
    if (!pshader)
        CG_Printf( NULL,"CG_Particle_Bleed pshader == ZERO!\n");
...
void CG_Particle_OilParticle (qhandle_t pshader, centity_t *cent)
{
    ...
    if (!pshader)
        CG_Printf( NULL,"CG_Particle_OilParticle == ZERO!\n");
...
void CG_Particle_OilSlick (qhandle_t pshader, centity_t *cent)
{
    ...
    if (!pshader)
        CG_Printf( NULL,"CG_Particle_OilSlick == ZERO!\n");
...
void CG_OilSlickRemove (centity_t *cent)
{
    ...
    if (!id)
        CG_Printf( NULL,"CG_OilSlickRevove NULL id\n");

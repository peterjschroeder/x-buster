...
// end changed RD
#define WINDOW_DRAGGABLE 			0x08000000  // Peter: Added for draggable windows
#define WINDOW_DRAG 			    0x10000000  // Peter: Added for draggable windows
...
typedef struct
{
    ...
    int				cursorx;
    int				cursory;
    int             mx, my;    // Peter: Draggable Windows
    qboolean		debug;

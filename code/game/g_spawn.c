...
void SP_func_capsule (gentity_t *ent); //capsules
...
void SP_trigger_light (gentity_t *ent);
...
void SP_shooter_pstrike( gentity_t *ent );
void SP_shooter_select( gentity_t *ent );
...
spawn_t	spawns[] =
{
    ...
    {"func_capsule", SP_func_capsule}, //added for capsules
    {"func_breakable", SP_func_breakable},
    {"func_explosive", SP_func_explosive},
    {"func_painroom", SP_func_painroom},
    {"func_regenroom", SP_func_regenroom},
    ...
    {"trigger_light", SP_trigger_light},
...
void G_SpawnGEntityFromSpawnVars( void )
{
    ...
    static char *gametypeNames[] = {"ffa", "tournament", "single", "team", "ctf", "teamtournament"};
...
void SP_worldspawn( void )
{
    ...
    trap_SetConfigstring( CS_MOTD, "testing" );		// message of the day

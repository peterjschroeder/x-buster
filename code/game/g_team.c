...
void Team_FragBonuses(gentity_t *targ, gentity_t *inflictor, gentity_t *attacker)
{
    ...
    if (targ->client->ps.powerups[enemy_flag_pw])
    {
        ...
        send_to_char(NULL, "%s" S_COLOR_WHITE " fragged %s's flag carrier!\n",
    ...
    if (tokens)
    {
        ...
        attacker->client->pers.teamState.fragcarrier++;
        send_to_char(NULL, "%s" S_COLOR_WHITE " fragged %s's skull carrier!\n",
                     attacker->client->pers.netname, TeamName(team));
...
void Team_ReturnFlag( int team )
{
    ...
    if( team == TEAM_FREE )
    {
        send_to_char(NULL, "The flag has returned!\n" );
    }
    else
    {
        send_to_char(NULL, "The %s flag has returned!\n", TeamName(team));
    }
}
...
int Team_TouchOurFlag( gentity_t *ent, gentity_t *other, int team )
{
    ...
    if ( ent->flags & FL_DROPPED_ITEM )
    {
        ...
        send_to_char( NULL, "%s" S_COLOR_WHITE " returned the %s flag!\n",
    ...
    send_to_char( NULL, "%s" S_COLOR_WHITE " captured the %s flag!\n", cl->pers.netname, TeamName(OtherTeam(team)));
...
int Team_TouchEnemyFlag( gentity_t *ent, gentity_t *other, int team )
{
    ...
    send_to_char (NULL, "%s" S_COLOR_WHITE " got the %s flag!\n",
...
int Pickup_Team( gentity_t *ent, gentity_t *other )
{
    ...
    {
        send_to_char ( other, "Don't know what team the flag is on.\n");
        return 0;
    }

...
{
    //
    if (bs->inventory[INVENTORY_WEAPON0] > 0 && bs->inventory[INVENTORY_AMMO0] > 0)
        return WEAPONINDEX_WEAPON0;
    else if (bs->inventory[INVENTORY_WEAPON1] > 0 && bs->inventory[INVENTORY_AMMO0] > 0)
        return WEAPONINDEX_WEAPON1;
    else if (bs->inventory[INVENTORY_WEAPON2] > 0 && bs->inventory[INVENTORY_AMMO1] > 0)
        return WEAPONINDEX_WEAPON2;
    else if (bs->inventory[INVENTORY_WEAPON3] > 0 && bs->inventory[INVENTORY_AMMO2] > 0)
        return WEAPONINDEX_WEAPON3;
    else if (bs->inventory[INVENTORY_WEAPON4] > 0 && bs->inventory[INVENTORY_AMMO4] > 0)
        return WEAPONINDEX_WEAPON4;
    else if (bs->inventory[INVENTORY_WEAPON5] > 0 && bs->inventory[INVENTORY_AMMO5] > 0)
        return WEAPONINDEX_WEAPON5;
    else if (bs->inventory[INVENTORY_WEAPON6] > 0 && bs->inventory[INVENTORY_AMMO6] > 0)
        return WEAPONINDEX_WEAPON6;
    else if (bs->inventory[INVENTORY_WEAPON7] > 0 && bs->inventory[INVENTORY_AMMO7] > 0)
        return WEAPONINDEX_WEAPON7;
    else if (bs->inventory[INVENTORY_WEAPON8] > 0 && bs->inventory[INVENTORY_AMMO8] > 0)
        return WEAPONINDEX_WEAPON8;
    else
    {
        return -1;
    }
